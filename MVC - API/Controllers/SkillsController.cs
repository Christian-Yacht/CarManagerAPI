    ...
    public class SkillsController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var skill = await _context.Skill
                .FirstOrDefaultAsync(m => m.SkillTitle == id);
            if (skill == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("SkillTitle,Description")] Skill skill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("SkillTitle,Description")] Skill skill)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!SkillExists(skill.SkillTitle))
                    {
                        return NotFound();
                    }
                    else
