...
namespace MVC_API.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            var user = await _context.Users.Include(a => a.Cars).Where(a => a.UserName == id).FirstOrDefaultAsync();

            // user kon niet gedelete worden als deze een auto had door deze regel (automatisch gegenereerd):
            // var user = await _context.Users.FindAsync(id);
            // het was niet mogelijk om vervolgens car.CarUser = null te doen omdat de cars van de user niet opgehaald zijn
            // regel herschreven tot bovenstaande regel om ook de cars mee te nemen.
